...
module Cms
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['CMS_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Cms::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Cms::Action is included
      ...
      # Configure the code that will yield each time Cms::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Cms::Assets::Helpers
      end
    end
